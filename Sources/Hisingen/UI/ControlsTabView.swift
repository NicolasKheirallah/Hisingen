        ...
        Card {
            VStack(alignment: .leading, spacing: 14) {
                ...
                if profile.hasSelectableSeatHeating {
                    ...
                    HStack(spacing: 12) {
                        SeatHeatingControl(title: L10n.text("Driver Seat"), level: $driverSeat) { newLevel in
                            Preferences.remoteDriverSeatHeating = newLevel
                        }
                        .disabled(true)

                        SeatHeatingControl(title: L10n.text("Passenger Seat"), level: $passengerSeat) { newLevel in
                ...
                if profile.permits(.preCleaning) {
                    Button {
    ...
    private var chargingControlCard: some View {
        Card {
            VStack(alignment: .leading, spacing: 12) {
                ...
                if profile.permits(.chargeTarget) {
                ...
                if profile.permits(.chargingCurrentLimit) {
                    VStack(alignment: .leading, spacing: 5) {
                        HStack {
