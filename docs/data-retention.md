...
| Command receipts | `UserDefaults` | All awaiting plus five recent terminal receipts per vehicle; until individually dismissed, cleared with the vehicle/session, or local vehicle data is erased |
