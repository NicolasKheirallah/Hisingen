...
struct ChargingHistoryExportTests {
    ...
    func testCSVShape() {
        ...
        #expect(lines[0] == "Date,Start Battery %,End Battery %,Battery Added %,kWh Delivered,Peak Power (kW),Duration (min),Estimated Cost,Currency,Energy Source,Confidence,Sample Coverage,Summary Version")
        ...
        #expect(cells[4] == "12.5")
        #expect(cells[8] == "kr")
        #expect(cells[9] == "legacy_estimate")
        #expect(cells[10] == "low")
        #expect(cells[12] == "1")
    }
