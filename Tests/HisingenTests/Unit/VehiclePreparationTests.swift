...
struct VehiclePreparationTests {
    ...
    func fetchPreparesAllDiscoveredIdentitiesAndInterleavedReadsRemainVINScoped() async throws {
        ...
        #expect(first.identity.modelName == "Polestar 4")
        #expect(first.identity.registrationNo == "ABC123")
        ...
        #expect(b.identity.vin == vinB)
        #expect(b.identity.modelName == "Polestar 2")
        #expect(b.identity.registrationNo == "DEF456")
        #expect(a.identity.vin == vinA)
        #expect(a.identity.modelName == "Polestar 4")
